document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    progressBar.style.width = ((questions.indexOf(question) + 1) / questions.length * 100) + `%`; // This value is hardcoded as a placeholder
    ...
    */
    ...
    question.choices.forEach(currentQuestion => {
      const newRadio = document.createElement("input");
      const newRadioLabel = document.createElement("label")
      newRadio.setAttribute("type", "radio")
      newRadio.setAttribute("name", "choice")
      newRadio.setAttribute("value", currentQuestion)
      newRadioLabel.innerText = currentQuestion
      choiceContainer.appendChild(newRadio);
      choiceContainer.appendChild(newRadioLabel);
